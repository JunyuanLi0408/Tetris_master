...
def evaluate(landing_height, peace_eroded, war_eroded, row_trans, col_trans, buried_holes, wells, combos):
    return -45 * landing_height + 340 * (peace_eroded + war_eroded) - 79 * buried_holes
